...
const Login = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const response = await axios.post('http://localhost:6161/api/auth/login', { email, password });

      // Если логин успешен, перенаправляем на главную страницу или другую защищенную страницу
